...
PATH_TO_LABELS = os.path.join(BASE, 'object_detection/data/mscoco_label_map.pbtxt')  # Add object_detection path
...
def get_objects(image, threshold=0.5):
    ...
    output_json = json.dumps([ob.__dict__ for ob in output], default=default)
    return output_json
